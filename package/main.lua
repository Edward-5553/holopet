...
lv_obj_set_size(APP.ui.session_title, 220, 20)
lv_obj_set_pos(APP.ui.session_title, 9, 3)
style_text(APP.ui.session_title, C.rust, FONT_16, ALIGN_LEFT)
...
style_text(APP.ui.session_clock, C.peach, FONT_14, ALIGN_RIGHT)
...
lv_obj_set_size(APP.ui.session_state, 72, 18)
lv_obj_set_pos(APP.ui.session_state, 5, 4)
style_text(APP.ui.session_state, C.bg, FONT_14, ALIGN_LEFT)
set_text(APP.ui.session_state, T("IDLE", "待命"))

APP.ui.session_tool = lv_label_create(APP.ui.session_state_segment)
lv_obj_set_size(APP.ui.session_tool, 82, 17)
lv_obj_set_pos(APP.ui.session_tool, 79, 5)
style_text(APP.ui.session_tool, C.bg, FONT_12, ALIGN_RIGHT)
